// filter item to get new category products data
...
export const filterItems = [
  {label: "Tất cả", value: FilterTypes.ALL},
  {label: "Bán chạy", value: FilterTypes.HOT},
  {label: "Hàng mới", value: FilterTypes.NEW},
  {
    label: "Giá thấp đến cao",
    value: FilterTypes.ASC,
  },
  {
    label: "Giá cao đến thấp",
    value: FilterTypes.DESC,
  },
];
