...
exports.makeProductInfosDb = void 0;
...
var makeProductInfosDb = function makeProductInfosDb(db) {
  // findOne, findAll, ...
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return db.ProductInfo.findByPk(id);
            case 3:
              rows = _context.sent;
              if (rows) {
                _context.next = 6;
  ...
  var findByConditions = function findByConditions(conditions) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
        var _yield$db$ProductInfo, rows, count, filterData;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return db.ProductInfo.findAndCountAll({
                where: conditions,
                order: [["createdAt", "DESC"]]
              });
            case 3:
              _yield$db$ProductInfo = _context2.sent;
              rows = _yield$db$ProductInfo.rows;
              _context2.next = 7;
              return db.ProductInfo.count();
            case 7:
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return db.ProductInfo.update(_objectSpread(_objectSpread({}, payload), {}, {
                updatedAt: new Date()
              }), {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return db.ProductInfo.destroy({
                where: whereCondition
              });
            case 3:
              recordDeleted = _context4.sent;
  ...
  var findAll = function findAll() {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(resolve, reject) {
        var _yield$db$ProductInfo2, count, rows, filterData;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 3:
              _yield$db$ProductInfo2 = _context6.sent;
              count = _yield$db$ProductInfo2.count;
              rows = _yield$db$ProductInfo2.rows;
              filterData = _libs.arrtributesHandler.filters(rows, attributes);
              resolve({
                infos: filterData
              });
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 4;
              return db.ProductInfo.create(payload, {
...
exports.makeProductInfosDb = makeProductInfosDb;