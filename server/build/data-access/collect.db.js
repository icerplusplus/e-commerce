...
var makeCollectsDb = function makeCollectsDb(db) {
  ...
  var findAll = function findAll() {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
        var _yield$db$Collect$fin, count, rows, filterData, amount;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return db.Collect.findAndCountAll({
                order: [["createdAt", "DESC"]],
                offset: (pagination.page - 1) * pagination.size,
                limit: pagination.size
              });
            case 3:
              _yield$db$Collect$fin = _context3.sent;
              count = _yield$db$Collect$fin.count;
              rows = _yield$db$Collect$fin.rows;
  ...
  var findByConditions = function findByConditions(conditions) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(resolve, reject) {
        var _yield$db$Collect$fin2, count, rows, filterData, amount;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              _yield$db$Collect$fin2 = _context4.sent;
              count = _yield$db$Collect$fin2.count;
              rows = _yield$db$Collect$fin2.rows;
              filterData = _libs.arrtributesHandler.filters(rows, attributes);
              amount = count === 0 || count - pagination.page * pagination.size <= 0 ? 0 : count - pagination.page * pagination.size;
              resolve({
                collects: filterData,
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 4;
              return db.Collect.create(payload, {
                fields: Object.keys(payload)
              });
            case 4:
              newCollect = _context5.sent;
              filterData = _libs.arrtributesHandler.filter(newCollect === null || newCollect === void 0 ? void 0 : newCollect.dataValues);
              resolve(filterData);
              _context5.next = 13;
              break;
            case 9:
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 4;
              return db.Collect.update(order, {
  ...
  var getMaxRows = function getMaxRows() {
    return new Promise( /*#__PURE__*/function () {
      var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(resolve, reject) {
        var _yield$db$Collect$fin3, count;
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              return db.Collect.findAndCountAll({});
            case 3:
              _yield$db$Collect$fin3 = _context9.sent;
              count = _yield$db$Collect$fin3.count;
              resolve(count);
              _context9.next = 11;
              break;
            case 8:
  ...
  var countRowsWithConditions = function countRowsWithConditions(whereCondition) {
    return new Promise( /*#__PURE__*/function () {
      var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(resolve, reject) {
        var _yield$db$Collect$fin4, count;
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 3:
              _yield$db$Collect$fin4 = _context10.sent;
              count = _yield$db$Collect$fin4.count;
              resolve(count);
              _context10.next = 11;
              break;
            case 8:
...
exports.makeCollectsDb = makeCollectsDb;