...
var makeUsersDb = function makeUsersDb(db) {
  // findOne, findAll, ...
  ...
  var findAll = function findAll() {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
        var _yield$db$User$findAn, count, rows, filterData, amount;
          ...
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return db.User.findAndCountAll({
                attributes: Object.keys(_models.User.rawAttributes).filter(function (key) {
                  return key !== "password";
                }),
  ...
  var findByConditions = function findByConditions(conditions) {
    ...
    return new Promise( /*#__PURE__*/function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(resolve, reject) {
        var _yield$db$User$findAn2, count, rows, filterData, amount;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 3:
              _yield$db$User$findAn2 = _context4.sent;
              count = _yield$db$User$findAn2.count;
              rows = _yield$db$User$findAn2.rows;
              filterData = _libs.arrtributesHandler.filters(rows, attributes);
              amount = count === 0 || count - pagination.page * pagination.size <= 0 ? 0 : count - pagination.page * pagination.size;
              resolve({
                users: filterData,
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 4:
              ...
              filterData = _libs.arrtributesHandler.filter(newUser === null || newUser === void 0 ? void 0 : newUser.dataValues, {
                excludes: ["password"]
              });
              resolve(filterData);
              _context5.next = 13;
  ...
  var getMaxRows = function getMaxRows() {
    return new Promise( /*#__PURE__*/function () {
      var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(resolve, reject) {
        var _yield$db$User$findAn3, count;
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              return db.User.findAndCountAll({});
            case 3:
              _yield$db$User$findAn3 = _context9.sent;
              count = _yield$db$User$findAn3.count;
              resolve(count);
              _context9.next = 11;
              break;
            case 8:
  ...
  var countRowsWithConditions = function countRowsWithConditions(whereCondition) {
    return new Promise( /*#__PURE__*/function () {
      var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(resolve, reject) {
        var _yield$db$User$findAn4, count;
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            ...
            case 3:
              _yield$db$User$findAn4 = _context10.sent;
              count = _yield$db$User$findAn4.count;
              resolve(count);
              _context10.next = 11;
              break;
            case 8:
  ...
  var getRefreshToken = function getRefreshToken(id) {
    return new Promise( /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            ...
            case 3:
              ...
              return _context11.abrupt("return", resolve(null));
            case 6:
              filterData = _libs.arrtributesHandler.filter(rows === null || rows === void 0 ? void 0 : rows.dataValues, {
...
exports.makeUsersDb = makeUsersDb;